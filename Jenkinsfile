    ...
    stages {
        stage('Git Checkout') {
            steps {
                ...
                git branch: 'main', credentialsId: 'git-token', url: 'https://github.com/kodjosenyedji/airbnb-infra-repo.git'
                sh 'ls'
            }
        }
